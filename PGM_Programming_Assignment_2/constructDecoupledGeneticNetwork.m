...
for i=1:numPeople
    if(pedigree.parents(i,1)==0)
        ...
        factorList(i)=childCopyGivenParentalsFactor(numAlleles, i, pedigree.parents(i,1), numPeople+pedigree.parents(i,1));
    end
end
for i=numPeople+1:(2*numPeople)
    if(pedigree.parents(i-numPeople,1)==0)
        ...
        factorList(i)=childCopyGivenParentalsFactor(numAlleles, i, pedigree.parents(i-numPeople,2), numPeople+pedigree.parents(i-numPeople,2));
    end
end
