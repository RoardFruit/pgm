...
num=length(genotypesToAlleles);
genotypeFactor.card=[num,num,num];
genotypeFactor.val = zeros(1, prod(genotypeFactor.card));
for i=1:length(genotypeFactor.val)
    assignments=IndexToAssignment(i,genotypeFactor.card);
    a=genotypesToAlleles(assignments(2),:);
    b=genotypesToAlleles(assignments(3),:);
    genotypeFactor.val(i)=sum([allelesToGenotypes(a(1),b(1)),allelesToGenotypes(a(1),b(2)),allelesToGenotypes(a(2),b(1)),allelesToGenotypes(a(2),b(2))]==assignments(1))/4;
end
