...
phenotypeFactor.card=repmat(2,1,5);
...
for i=1:length(phenotypeFactor.val)
    ...
    prob=computeSigmoid(alleleWeights{1}(assignments(2))+alleleWeights{2}(assignments(3))+alleleWeights{1}(assignments(4))+alleleWeights{2}(assignments(5)));
    if(assignments(1)==1)
